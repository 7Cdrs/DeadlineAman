...
export default function Footer() {
  return (
    <footer className="w-full max-w-full overflow-hidden bg-gradient-to-br from-[#1a5f8f] via-[#1e7cba] to-[#1a5f8f] text-white pt-8 sm:pt-10 md:pt-12 pb-4 sm:pb-5 md:pb-6 relative">
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10 text-center md:text-left relative z-10">
        ...
        <div className="w-full">
          ...
          <ul className="space-y-1.5 sm:space-y-2 text-white/95 text-sm sm:text-base">
            <li className="flex justify-center md:justify-start items-center gap-2 hover:text-white transition-colors duration-300 drop-shadow-sm">
              ...
              <span className="break-all truncate max-w-full">support@deadlineaman.my.id</span>
            </li>
            <li className="flex justify-center md:justify-start items-center gap-2 hover:text-white transition-colors duration-300 drop-shadow-sm">
